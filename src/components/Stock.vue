...
<img width="7%" src="../assets/4p.png" style="margin-top:-250px;margin-left:50px"> </br>
<br><br>
<div v-if = "type === 'stock'" >
<div class="columns">
  <div class="column"></div>
    <div class="column is-two-thirds">
      <table>
        <tr>
          <td> <input class="input is-black" type="text" placeholder="ชื่อสินค้า"  v-model="data.name" ></td>  &nbsp; &nbsp; &nbsp; &nbsp;
          <td> <input class="input is-black" type="text" placeholder="จำนวน"  v-model="data.number"></td>&nbsp; &nbsp; &nbsp; &nbsp;
          <td> <input class="input is-black" type="text" placeholder="ราคา"  v-model="data.price"></td> &nbsp; &nbsp; &nbsp; &nbsp;
          <td>
            <div class="file">
          ...
          <td> <a class="button is-black is-outlined" @click="insert()">+ADD</a> </td>
        </tr>
      </table>
    </div>
  <div class="column"></div>
  ...
  <div class="column"></div>
      <table class="table is-fullwidth" >
        ...
        <tbody v-for =" (stock,key) in showstock"  >
          <tr  v-if = "sw !== key" >
            <td>  <img :src="stock.image"style="width: 200px; height: 180px;"></td>
            <td> </br> </br>{{stock.name}}</td>
            <td> </br></br> {{stock.number}}</td>
            <td> </br></br> {{stock.price}}</td>

            <td> </br></br><a class="button is-black " @click="swap(key)">Update</a> </td>
            <td> </br></br><a class="button is-black " @click="Delete(key)">Delete</a> </td>
         </tr>
            <tr  v-else >
...
<div class="order"  v-if = "type === 'Order'" >
      ...
      <table class="table is-striped is-narrow is-hoverable is-fullwidth" >
        ...
        <tbody v-for =" (stock,key) in showstock"  >
          <tr>
            <td >  <img :src="stock.image"style="width: 350px; height: 300px;"></td>
...
var config = {
  apiKey: 'AIzaSyDatQa2TeJG9HLC6yumS02WIO40wjKw0s4',
    authDomain: 'store-bd6ab.firebaseapp.com',
    databaseURL: 'https://store-bd6ab.firebaseio.com',
    projectId: 'store-bd6ab',
    storageBucket: 'store-bd6ab.appspot.com',
    messagingSenderId: '805091674279'
  }
